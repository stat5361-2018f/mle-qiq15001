...
$$\ell'=\sum_{i=1}^n\frac{\sin(x_i-\theta)}{1-\cos(x_i-\theta)}$$
$$\ell''=\sum_{i=1}^n\frac{\cos(x_i-\theta)[1-\cos(x_i-\theta)]-[\sin(x_i-\theta)]^2}{[1-\cos(x_i-\theta)]^2}$$
$$=\sum_{i=1}^n\frac{\cos(x_i-\theta)-1}{[1-\cos(x_i-\theta)]^2}=\sum_{i=1}^n\frac{1}{\cos(x_i-\theta)-1}$$
